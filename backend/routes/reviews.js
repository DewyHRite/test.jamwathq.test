...
router.post('/', isAuthenticated, async (req, res) => {
    try {
        const {
            ...
            experience,
            timesUsed,
            visitYear,  // Year(s) of visit - See docs/share-experience-review.md
            tosAccepted
        } = req.body;
        ...
        // Validate experience minimum length (20 characters after trimming)
        const experienceTrimmed = experience.trim();
        if (experienceTrimmed.length < 20) {
            return res.status(400).json({
                success: false,
                message: 'Experience must be at least 20 characters. Please provide more detail about your experience.'
            });
        }
        ...
        const review = new Review({
            ...
            visitYear: visitYear || '',  // Optional field for year(s) of visit
            tosAccepted: true,
