				...
				const scoreboardHTML = `
					<div class="scoreboard-list">
						${sortedStates.map((entry, index) => {
							...
							return `
								<div class="scoreboard-item" onclick="openReviewsPopup('${escapeHtml(state)}')" style="cursor: pointer;" role="button" tabindex="0" aria-label="View reviews for ${escapeHtml(state)}">
